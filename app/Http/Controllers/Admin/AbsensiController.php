...
class AbsensiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.absensi.index', compact('tahunPelajaran', 'kelas'));
    }
            ...
            ->addColumn('action', function ($row) {
                $content = '<div class="dropdown dropdown-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="' . route("admin.absensi.rekap.index", $row) . '"><i class="fa-solid fa-eye m-r-5"></i> Rekap</a>
                        </div>
                    </div>';
                return $content;
            })
