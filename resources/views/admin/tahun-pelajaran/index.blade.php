            ...
            <div class="card card-table show-entire">
                <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <div class="doctor-table-blk">
                                    <h3>Data Tahun Pelajaran</h3>
                                    <div class="doctor-search-blk mt-3 mt-md-0">
                                        <div class="top-nav-search table-search-blk">
                                            <form onsubmit="event.preventDefault(); searchDataTable('#tableTahunPelajaran');">
                                                <input type="text" class="form-control" id="search-table"
                                                    oninput="searchDataTable('#tableTahunPelajaran')" placeholder="Search here">
                                                <a class="btn"><img
                                        ...
                                        <div class="add-group">
                                            <a href="{{ route('admin.tahun-pelajaran.add') }}"
                                                class="btn btn-primary add-pluss ms-2"><img
                                                    src="{{ asset('template') }}/assets/img/icons/plus.svg"
                                                    alt=""></a>
                                            <a href="javascript:void(0);" onclick="searchDataTable('#tableTahunPelajaran', true)"
                    ...
                    <div class="table-responsive">
                        <table id="tableTahunPelajaran" class="table border-0 custom-table comman-table datatable mb-0 table-hover">
                            <thead>
                                <tr>
...
@push('script')
    <script>
        var table1 = dataTable('#tableTahunPelajaran');
        $('#search-table').focus();
        ...
        function dataTable(tableId) {
            var url = "{{ route('admin.tahun-pelajaran.data') }}"
        ...
        function deleteData(event) {
            ...
            swal({
                ...
                if (willDelete) {
                    var url = "{{ route('admin.tahun-pelajaran.destroy', ['tahunPelajaran' => '_tahunPelajaran']) }}";
                    url = url.replace('_tahunPelajaran', id);
