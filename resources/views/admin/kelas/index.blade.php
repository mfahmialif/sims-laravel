            ...
            <div class="card card-table show-entire">
                <div class="card-body">
                                        ...
                                        <div class="top-nav-search table-search-blk">
                                            <form onsubmit="event.preventDefault(); searchDataTable('#tableKelas');">
                                                <input type="text" class="form-control" id="search-table"
                                                    oninput="searchDataTable('#tableKelas')" placeholder="Search here">
                                                <a class="btn"><img
                                        ...
                                        <div class="add-group">
                                            <a href="{{ route('admin.kelas.add') }}"
                                                class="btn btn-primary add-pluss ms-2"><img
                                                    ...
                                                    alt=""></a>
                                            <a href="javascript:void(0);" onclick="searchDataTable('#tableKelas', true)"
                    ...
                    <div class="table-responsive">
                        <table id="tableKelas" class="table border-0 custom-table comman-table datatable mb-0 table-hover">
                            <thead>
                                <tr>
