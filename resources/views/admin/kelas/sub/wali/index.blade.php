                            ...
                            <div class="col">
                                <div class="doctor-table-blk">
                                    ...
                                    <div class="doctor-search-blk mt-3 mt-md-0">
                                        ...
                                        <div class="add-group">
                                            <a href="{{ route('admin.kelas.sub.wali.add', ['kelas' => $kelas, 'kelasSub' => $kelasSub]) }}"
...
@push('script')
    <script>
        ...
        function dataTable(tableId) {
            var url = "{{ route('admin.kelas.sub.wali.data', ['kelas' => $kelas, 'kelasSub' => $kelasSub]) }}"
        ...
        function deleteData(event) {
            ...
            swal({
                ...
                if (willDelete) {
                    var url = "{{ route('admin.kelas.sub.wali.destroy', ['kelas'=> $kelas, 'kelasSub' => $kelasSub, 'kelasWali' => '_kelasWali']) }}";
                    url = url.replace('_kelasWali', id);
