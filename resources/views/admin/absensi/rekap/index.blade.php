                            ...
                            <div class="col">
                                <div class="doctor-table-blk">
                                    ...
                                    <div class="doctor-search-blk mt-3 mt-md-0">
                                        ...
                                        <div class="add-group">
                                            <a href="{{ route('admin.absensi.rekap.add', ['jadwal' => $jadwal]) }}"
...
@push('script')
    <script>
        ...
        function dataTable(tableId) {
            var url = "{{ route('admin.absensi.rekap.data', ['jadwal' => $jadwal]) }}"
        ...
        function deleteData(event) {
            ...
            swal({
                ...
                if (willDelete) {
                    var url = "{{ route('admin.absensi.rekap.destroy', ['jadwal' => $jadwal, 'absensi' => '_absensi']) }}";
