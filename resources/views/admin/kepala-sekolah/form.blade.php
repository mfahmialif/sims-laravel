...
<div class="col-12 col-sm-6">
    <div class="input-block local-forms">
        ...
        <input class="form-control @error('mulai_menjabat') is-invalid @enderror" id="mulai_menjabat"
            name="mulai_menjabat" type="date" value="{{ old('mulai_menjabat') }}" tabindex="2">
...
<div class="col-12 col-sm-6">
    <div class="input-block local-forms">
        <label>Selesai Menjabat</label>
        <input class="form-control @error('selesai_menjabat') is-invalid @enderror" id="selesai_menjabat"
            name="selesai_menjabat" type="date" value="{{ old('selesai_menjabat') }}" tabindex="3">
...
<div class="col-12">
    <div class="doctor-submit text-end">
        ...
        <button onclick="location.href = '{{ route('admin.kepala-sekolah.index') }}'" type="button"
