                            ...
                            <div class="col">
                                <div class="doctor-table-blk">
                                    ...
                                    <div class="doctor-search-blk mt-3 mt-md-0">
                                        ...
                                        <div class="add-group">
                                            <a href="{{ route('admin.kepala-sekolah.add') }}"
...
@push('script')
    <script>
        ...
        function dataTable(tableId) {
            var url = "{{ route('admin.kepala-sekolah.data') }}"
        ...
        function deleteData(event) {
            ...
            swal({
                ...
                if (willDelete) {
                    var url = "{{ route('admin.kepala-sekolah.destroy', ['kepalaSekolah' => '_kepalaSekolah']) }}";
                    url = url.replace('_kepalaSekolah', id);
