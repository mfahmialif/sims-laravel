...
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('siswa.profile.index') }}">Profile </a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="form_edit" action="{{ route('siswa.profile.update') }}" onsubmit="submitForm(this)" method="POST"
