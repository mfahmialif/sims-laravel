...
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('siswa.dashboard.index') }}">Dashboard </a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('siswa.dashboard.update') }}"
...
@push('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            form.find('select[name="status"]').val(getValue('status')).change();
