...
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('guru.dashboard.index') }}">Dashboard</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('guru.dashboard.update', ['guru' => $guru]) }}" onsubmit="submitForm(this)"
