...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('guru.nilai.input.store', ['jadwal' => $jadwal]) }}" onsubmit="submitForm(this)"
                        ...
                        <div class="row">
                            ...
                            @include('guru.nilai.input.form', [
                                'url' => route('guru.nilai.input.data-form', ['jadwal' => $jadwal]),
                            ])
